...
0. In the exposome folder, unzip the acs_estimates.csv.zip folder and save it in the exposome folder with the other csv files.
...
Once all code has been run, be sure to delete cohort_inclusion_[site].csv, cohort_inclusion_periop.csv, and exclusions_raw from the run_[site] folder in output as this has line-level patient data.
